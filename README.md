...
- A "Trials" quick-filter chip aggregates every trial-shaped article — Randomized Controlled Trial, Clinical Trial, Multicenter Study, Landmark Trial, and Trial Tracker's status-suffixed entries — from every section into one filtered view, alongside the existing single-study-type chips (RCT, Meta-Analysis, Review, Guideline).
