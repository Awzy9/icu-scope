...
module.exports = function handler(req, res) {
  ...
  const knowledgeMapUrl = process.env.NEXT_PUBLIC_KNOWLEDGE_MAP_URL || "https://default-project-green.vercel.app";
  const mvSimulatorUrl = process.env.NEXT_PUBLIC_MV_SIMULATOR_URL || "";
